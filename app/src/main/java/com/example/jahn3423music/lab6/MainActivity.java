 ...
 *
 * Questions:
 * 1) When an invalid city is entered, the app tries to autocorrect your input to a city that has a close enough spelling to your entry.
 *      If the program can't fix it, then it returns a 502 error.
 * 2) The API key is "8301442678d36413b4e3a04d016deee7". This key allows the user to access the weather service that provides forecast
 *      data to the user for the inputted city.
 ...
 * 4) The system takes the JSON data and organizes it in a readable manner for the user in order to communicate the forecast for the next 7 days.
 * 5) The Weather class is designed to simply contain the weather information for a day, and convert the timestamp into a simple Day format
 *
 **/
